  ...
  return (
    <div className="grid gap-4">
      ...
      >
        ...
        <Button
          type="submit"
          className="w-full bg-primary text-black hover:bg-primary/90 font-black text-lg h-12 rounded-xl shadow-lg shadow-primary/10 transition-all border-none mt-2"
        >
          Login
        </Button>
      </form>
      ...
      >
        <Button
          variant="outline"
          type="submit"
          className="w-full h-12 gap-3 cursor-pointer hover:bg-slate-50 border-slate-100 hover:border-primary/50 hover:text-primary transition-all duration-300 group rounded-xl font-bold"
        >
          <svg
