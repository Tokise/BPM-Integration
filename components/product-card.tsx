            ...
            >
                <div className="aspect-[4/3] bg-slate-50 relative overflow-hidden w-full">
                    ...
                    <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button
                            onClick={(e) => { e.preventDefault(); e.stopPropagation(); addToCart({ id: product.id, shop_id: product.shop_id, name: product.name, price: product.price, category: product.category, images: product.images, image: product.image }); }}
