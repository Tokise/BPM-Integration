      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-500 font-medium">
            ...
            communication and mobile fleet
            tracking.
          </p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          <div className="space-y-2">
            ...
            <p className="text-slate-500 font-medium">
              Download the driver app or use the
            ...
            {[
              {
                ...
                desc: "Instant task push notifications",
                icon: Zap,
              },
              {
                title: "Geo-Fencing",
                desc: "Automated hub entry/exit logs",
                icon: MapPin,
              },
              {
                title: "Proof of Delivery",
                desc: "Photo and signature capture",
                icon: Lock,
              },
            ].map((item, i) => (
              <div
                key={i}
                className="flex gap-4 p-4 rounded-2xl bg-white shadow-sm border border-slate-50 group hover:border-primary/20 transition-all"
              >
          ...
          <div className="pt-4 flex gap-3">
            <Button className="flex-1 bg-slate-900 text-white rounded-xl h-11 font-black">
              App Store
            </Button>
            <Button className="flex-1 bg-slate-900 text-white rounded-xl h-11 font-black">
              Play Store
