          ...
          >
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div
                  className={`h-2 w-2 rounded-full ${stat.color === "green" ? "bg-green-500" : stat.color === "amber" ? "bg-amber-500" : "bg-slate-300"}`}
                />
              </div>
            ...
            {[1, 2, 3, 4, 5].map((i) => (
              ...
              >
                <div className="h-14 w-11 bg-slate-50 rounded-lg flex flex-col items-center justify-center border border-slate-100 group-hover:bg-white group-hover:border-primary/20 transition-all">
                  ...
                  <span className="text-[8px] font-black text-slate-300 mt-1">
                    PDF
                  </span>
                </div>
                <div className="flex-1">
                  <h4 className="font-bold text-slate-900 leading-tight">
                    WB-2026-X09{i}-MANILA-HUB
                  </h4>
                  <p className="text-[10px] text-slate-500 font-medium">
                    Waybill • Uploaded by Admin •
                    Feb 10, 2026
                  </p>
                </div>
