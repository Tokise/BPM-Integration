...
import { School, Calendar, Users, Search } from "lucide-react";
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex flex-col gap-2">
                    <h1 className="text-4xl font-black tracking-tighter text-slate-900">Training Management</h1>
                    <p className="font-bold text-slate-500 uppercase text-[10px] tracking-[0.2em]">Coordinate corporate training sessions</p>
                </div>
                <Button className="bg-amber-500 hover:bg-amber-600 text-white font-black rounded-xl h-12 px-6 flex items-center gap-2 shadow-lg shadow-amber-200">
                    <Calendar className="h-5 w-5" /> Schedule Class
                </Button>
            </div>
            ...
            <Card className="border-none shadow-2xl shadow-slate-100 rounded-[32px] bg-white overflow-hidden">
                ...
                <CardContent className="p-8 text-center py-20">
                    ...
                    <p className="font-bold text-slate-400">No training sessions scheduled.</p>
                </CardContent>
            </Card>
        </div>
    );
