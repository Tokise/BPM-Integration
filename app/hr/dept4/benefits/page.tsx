        ...
        <div className="flex items-center gap-3">
          <div className="relative group w-64">
            ...
            <Input
              ...
              className="pl-11 h-10 bg-white border border-slate-200 rounded-lg focus-visible:ring-emerald-500 font-medium text-xs"
              value={searchQuery}
              onChange={(e) =>
              ...
              >
                <CardContent className="p-8">
                  <div className="flex justify-between items-start mb-6">
                    <div className="h-10 w-10 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center font-black border border-emerald-100">
                      <Heart className="h-6 w-6" />
                    </div>
                    <button className="h-8 w-8 rounded-lg hover:bg-slate-50 flex items-center justify-center text-slate-400">
                  ...
                  <div className="space-y-1 mb-6">
                    ...
                    <h3 className="text-xl font-black text-slate-900 tracking-tighter transition-all">
                      <PrivacyMask
                        value={b.employee_name}
                      />
                    </h3>
                  </div>
                  <div className="flex items-center gap-4 py-4 border-y border-slate-50 mb-6 font-bold text-slate-400 text-[10px] uppercase tracking-widest">
