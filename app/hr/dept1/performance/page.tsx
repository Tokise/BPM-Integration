      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-6">
              ...
              <Card className="border-none shadow-sm rounded-[32px] p-8 text-center bg-slate-50/30 border border-slate-100">
                <div className="flex items-center justify-center gap-3 text-slate-400">
                  ...
                  <p className="text-xs font-bold uppercase tracking-widest">
                    Evaluation season is currently
                    closed
                  </p>
                </div>
              </Card>
          ...
          <div className="grid gap-4">
            ...
            ) : !isEvalOpen && !isMasterHr ? (
              <div /> // Hidden for non-HR when closed (Leaderboard shown above)
            ) : filtered.length === 0 ? (
