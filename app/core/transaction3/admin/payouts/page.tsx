...
import { Landmark, Banknote, History, Search } from "lucide-react";
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex flex-col gap-2">
                    ...
                    <p className="font-bold text-slate-500 uppercase text-[10px] tracking-[0.2em]">Handle seller disbursements and banking</p>
                </div>
            ...
            <Card className="border-none shadow-2xl shadow-slate-100 rounded-[32px] bg-white overflow-hidden p-12 text-center flex flex-col items-center">
                ...
                <h3 className="text-xl font-black text-slate-900">Financial Settlements</h3>
                <p className="text-slate-500 font-bold mt-2">Settlement cycles are currently up to date.</p>
