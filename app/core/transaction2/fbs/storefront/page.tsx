...
export default function SellerStorefrontPreview() {
  ...
  if (!shop) {
    return (
      <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-300">
        ...
        <Button className="bg-primary text-black font-black px-8 rounded-lg shadow-lg shadow-primary/20">
          Set Up Shop
        </Button>
      </div>
    );
  ...
  return (
    <div className="space-y-8 max-w-[1400px] mx-auto pb-20">
      ...
      {/* Context Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-lg border border-slate-200 shadow-none">
        ...
        <div className="flex items-center gap-3">
          <Button
            variant="ghost"
            className="rounded-lg h-11 px-6 font-bold text-slate-500 gap-2 border border-slate-100 hover:bg-slate-50"
          >
            <Share2 className="h-4 w-4" /> Share
            Shop
          </Button>
          <Button className="rounded-lg h-11 px-6 font-black bg-slate-900 text-white gap-2 hover:scale-105 transition-transform">
      ...
      {/* Banner Section */}
      <div className="relative h-64 md:h-80 bg-slate-100 rounded-lg overflow-hidden group shadow-none border border-slate-200">
        {shop.banner_url ? (
          <img
            src={shop.banner_url}
      ...
      <div className="px-10 pb-10 -mt-20 relative z-10 flex flex-col lg:flex-row items-end justify-between gap-8">
        <div className="flex flex-col md:flex-row items-end gap-6 w-full lg:w-auto">
          <div className="h-40 w-40 bg-white rounded-lg shadow-none border border-slate-200">
            <div className="h-full w-full bg-slate-50 rounded-lg flex items-center justify-center text-slate-200 overflow-hidden">
              {shop.avatar_url ? (
                <img
                  src={shop.avatar_url}
                  alt={shop.name}
        ...
        <div className="flex items-center gap-3 pb-2">
          <Button className="h-14 px-8 rounded-lg bg-amber-500 text-black font-black uppercase text-xs tracking-widest shadow-none border border-amber-600/10 hover:scale-105 transition-transform active:scale-95">
            Follow Shop
          </Button>
          <Button
            variant="ghost"
          ...
          <div className="flex items-center gap-2">
            <div className="relative w-[240px]">
              ...
              <Input
                ...
                className="h-10 pl-10 rounded-lg bg-white border border-slate-100 shadow-none text-xs font-bold"
              />
            </div>
          </div>
        </div>
      ...
      <Card className="border border-slate-200 shadow-none rounded-lg p-10 bg-white grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="relative group">
          <div className="h-[300px] bg-slate-50 rounded-lg overflow-hidden flex items-center justify-center text-slate-200 border border-slate-100">
