    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-300">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="font-bold text-slate-500 uppercase text-[10px] tracking-[0.2em] mt-1">
          Core 2: Reverse Logistics & Refunds
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="border border-slate-200 shadow-none rounded-lg p-6 bg-white overflow-hidden group transition-all duration-300">
          <div className="flex items-center gap-4">
            <div className="h-12 w-12 bg-amber-50 text-amber-500 rounded-lg flex items-center justify-center transition-colors">
            ...
            <div>
              ...
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-[9px] font-black bg-amber-50 text-amber-600 px-1.5 py-0.5 rounded uppercase tracking-tighter ml-2">
                  +2.1%
                </span>
              </div>
            </div>
        ...
        <Card className="border border-slate-200 shadow-none rounded-lg p-6 bg-white overflow-hidden group transition-all duration-300">
          <div className="flex items-center gap-4">
            <div className="h-12 w-12 bg-orange-50 text-orange-600 rounded-lg flex items-center justify-center transition-colors">
            ...
            <div>
              ...
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-[9px] font-black bg-orange-50 text-orange-600 px-1.5 py-0.5 rounded uppercase tracking-tighter ml-2">
                  -1.4%
                </span>
              </div>
            </div>
      ...
      <Tabs
        ...
        className="space-y-8"
      >
        <TabsList className="bg-slate-100 p-1 rounded-lg h-12">
          <TabsTrigger
            value="returns"
            className="rounded-lg px-6 font-black uppercase text-[10px] tracking-widest data-[state=active]:bg-white data-[state=active]:shadow-sm"
          >
      ...
      >
        <DialogContent className="mt-10 sm:max-w-[900px] max-h-[90vh] overflow-y-auto rounded-lg border-none shadow-none p-0 overflow-hidden bg-white">
