...
export default function ShopManagementPage() {
  ...
  const handleImageUpload = async (
    ...
    try {
      ...
      updateShop(updatedShop);
      toast.success(
        `${type === "avatar_url" ? "Logo" : "Banner"} updated!`,
      );
    } catch (error: any) {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Button
            onClick={handleSave}
            disabled={isSaving}
            className="bg-slate-900 hover:bg-slate-800 text-white font-black rounded-lg h-11 shadow-none px-8 flex items-center gap-2"
          >
            {isSaving ? (
      ...
      {/* Banner Section */}
      <div className="relative h-64 md:h-72 bg-slate-100 rounded-lg shadow-none border border-slate-200">
        {shop.banner_url ? (
          <img
            src={shop.banner_url}
        ...
        <div className="absolute bottom-6 right-6">
          <UiLabel
            ...
            className="flex items-center gap-2 bg-white/90 backdrop-blur px-4 py-2.5 rounded-lg text-[10px] font-black uppercase tracking-widest cursor-pointer shadow-none hover:bg-white transition-all border border-slate-200"
          >
            ...
            <input
              ...
              accept="image/*"
              onChange={(e) =>
                handleImageUpload(e, "banner_url")
              }
      ...
      <div className="grid lg:grid-cols-12 gap-8 mt-10 px-2 lg:px-6 relative z-10">
        ...
        <div className="lg:col-span-4 space-y-6">
          <Card className="p-10 border border-slate-200 shadow-none rounded-lg bg-white text-center flex flex-col items-center group">
            <div className="relative group/avatar">
              <div className="h-40 w-40 bg-white rounded-lg shadow-none border border-slate-200 p-2 overflow-hidden mb-6">
          ...
          <Card className="p-6 border border-slate-200 shadow-none rounded-lg flex items-center gap-4 bg-white">
        ...
        <div className="lg:col-span-8">
          <Card className="p-10 border border-slate-200 shadow-none rounded-lg bg-white space-y-8">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-2">
                <UiLabel className="text-[10px] font-black uppercase text-slate-400 tracking-widest ml-1">
                  Shop Name
                </UiLabel>
                <Input
                  value={formData.name}
                  ...
                  className="h-14 rounded-lg bg-slate-50 border-none font-bold text-slate-900 focus-visible:ring-amber-500/20"
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="min-h-[140px] rounded-lg bg-slate-50 border-none font-medium text-slate-600 resize-none p-6 focus-visible:ring-amber-500/20"
              />
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-14 pl-12 rounded-lg bg-slate-50 border-none font-bold text-slate-900 focus-visible:ring-amber-500/20"
                  />
                </div>
              </div>
