          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {allProviders.map((provider) => {
              ...
              return (
                <Card
                  key={provider.id}
                  className={`border border-slate-200 shadow-none rounded-lg bg-white group hover:scale-[1.02] transition-all duration-300 relative overflow-hidden ${isEnabled ? "ring-2 ring-slate-900" : ""}`}
                >
                  {provider.is_default && (
                    <div className="absolute top-0 right-0 bg-amber-500 text-white text-[8px] font-black uppercase px-4 py-1 rounded-bl-lg tracking-widest flex items-center gap-1">
                  ...
                  <CardHeader className="p-8 pb-4">
                    <div className="h-12 w-12 bg-slate-50 rounded-lg flex items-center justify-center text-slate-900 mb-4 group-hover:bg-slate-900 group-hover:text-white transition-all duration-500 shadow-sm border border-slate-100">
