      ...
      <div className="relative h-64 md:h-72 bg-slate-100 rounded-[40px] overflow-hidden group shadow-inner">
        ...
        <div className="absolute bottom-6 right-6">
          <UiLabel
            ...
            className="flex items-center gap-2 bg-white/90 backdrop-blur px-4 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest cursor-pointer shadow-xl hover:bg-white transition-all"
          >
