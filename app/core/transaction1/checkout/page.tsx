...
function CheckoutContent() {
        ...
        return (
            <div className="container mx-auto px-4 py-20 flex flex-col items-center text-center gap-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <Button size="lg" variant="outline" className="font-bold h-14 px-10 rounded-2xl border-slate-200" onClick={() => router.push('/core/transaction1/purchases')}>
                        View My Purchase
                    </Button>
                </div>
            </div>
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-7xl">
            <Link href={productId ? `/core/transaction1/product/${productId}` : "/"} className="flex items-center text-sm font-medium text-muted-foreground hover:text-primary mb-8">
                        ...
                        <CardContent className="p-6">
                            {showAddressList ? (
                                <div className="space-y-3">
                                    ...
                                    <Button onClick={() =>
                                        router.push('/core/transaction1/profile?tab=address')} variant="outline" className="w-full h-11 rounded-xl border-dashed border-2 
font-bold opacity-60 hover:opacity-100 transition-opacity">Manage Addresses</Button>
                                </div>
                            ) : (
                                selectedAddress ? (
