  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <Card className="border-none shadow-2xl shadow-slate-100 rounded-[32px] bg-white overflow-hidden p-12">
        <CardTitle className="text-2xl font-black mb-6">
        ...
        <div className="space-y-6">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="pb-6 border-b border-slate-50 last:border-0"
            >
              <h4 className="font-bold text-slate-900 mb-2">
                How do I track my order?
              </h4>
              <p className="text-sm text-slate-500">
                You can track your order by going
                to the 'Order Tracking' section in
                your profile...
              </p>
            </div>
          ))}
