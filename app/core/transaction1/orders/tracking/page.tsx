    ...
    <div className="max-w-4xl mx-auto py-8 px-4 space-y-8">
                    ...
                    <div className="relative flex justify-between">
                      {[
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`h-8 w-8 rounded-xl flex items-center justify-center z-10 transition-all ${
                                isActive
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {orderData.order_items?.map(
                      (item: any) => (
                        <div
                          key={item.id}
                          className="p-3 bg-slate-50 rounded-2xl flex gap-3 items-center group border border-slate-100/50 hover:shadow-sm transition-all"
                        >
                    ...
                    {[
                      ...
                      >
                        <div className="flex flex-col items-center">
                          <div
                            className={`h-3 w-3 rounded-full border-[3px] ${log.current ? "bg-primary border-slate-900" : "bg-white border-slate-200"} z-10 mt-1`}
                          />
                          {i !== 2 && (
                        ...
                        <div className="pb-1 text-left">
                          <div className="flex flex-col">
                            <p
                              className={`font-black tracking-tight leading-none mb-1 ${log.current ? "text-slate-900 text-sm" : "text-slate-500 text-xs"}`}
                            >
                              {log.status}
                            </p>
      ...
      <div className="bg-amber-50 rounded-3xl p-8 border border-amber-100 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <Link href="/core/transaction1/support">
          <Button className="bg-amber-900 text-white px-8 h-12 rounded-2xl font-black hover:bg-amber-800 transition-all">
            Contact Support
          </Button>
        </Link>
      </div>
