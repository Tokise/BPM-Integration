    ...
    if (user) {
        ...
        if (profileRole) {
          ...
          if (
            ...
            if (roleStr === "admin") {
              ...
              roleStr.startsWith("hr1_")
            ) {
              finalRedirect = "/hr/dept1";
            } else if (
              roleStr.startsWith("hr2_")
            ) {
              finalRedirect = "/hr/dept2";
            } else if (
              roleStr.startsWith("hr3_")
            ) {
              finalRedirect = "/hr/dept3";
            } else if (
              roleStr.startsWith("hr4_")
            ) {
      ...
      if (isEmployee && user.email) {
        const { generateAndSendOTP } =
          await import("@/app/actions/auth_otp");
    ...
    <div className="w-full min-h-screen lg:grid lg:grid-cols-2">
      <div className="hidden lg:flex flex-col items-center justify-center relative ">
        ...
        <div className="relative z-10 max-w-lg text-center p-10">
          ...
          <p className="text-lg text-amber-800/80">
            ...
            discovering unique local products
            every day.
          </p>
        </div>
      </div>
      <div className="flex items-center justify-center py-12 bg-white relative">
        ...
        <div className="mx-auto grid w-[350px] gap-6 px-4">
          ...
          <SignInForm
            signInEmailAction={signInWithEmail}
            signInGoogleAction={signInWithGoogle}
          />
