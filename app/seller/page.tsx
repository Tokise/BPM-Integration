    ...
    return (
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col gap-2">
                ...
                <p className="font-bold text-slate-500 uppercase text-[10px] tracking-[0.2em]">Manage Your Shop & Products</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    { label: "Total Orders", value: "342", icon: ShoppingBag },
                    { label: "Product Rating", value: "4.8", icon: Star },
                    { label: "Products Listed", value: "156", icon: Package },
                    { label: "New Messages", value: "5", icon: MessageCircle },
                ].map((stat, idx) => (
