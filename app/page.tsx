        ...
        <div className="container mx-auto px-4 hidden md:block">
          <div className="flex items-center gap-0 border-b border-border/40">
            ...
            <nav className="flex-1 flex items-center gap-6 px-10 text-[11px] font-black text-slate-500 uppercase tracking-widest justify-between">
              ...
              <a
                href="#"
                className="hover:text-primary transition-colors cursor-pointer whitespace-nowrap border-b-2 border-primary text-slate-900 px-2 h-full flex items-center"
              >
                HOME DÉCOR
              </a>
            </nav>
      ...
      <section className="container mx-auto px-4">
        <div className="flex items-center justify-between mb-8">
          ...
          <Button
            ...
            onClick={() =>
              router.push(
                "/core/transaction1/search",
              )
            }
            className="text-amber-500 font-bold text-base cursor-pointer hover:text-amber-600 transition-colors"
          >
            View all
          </Button>
        </div>
